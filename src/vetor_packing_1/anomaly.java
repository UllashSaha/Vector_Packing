        ...
        this.arrayOfBins = new bin[k];
            ...
            try {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    xValue = Integer.parseInt(array[0]);
                    yValue = Integer.parseInt(array[1]);
...
//        }
     ...
     public int Algorithm_for_placeitem(int j) {
        ...
        for (i = 0; i < copyOfBinArray.length; i++) {
            ...
            if (copyOfBinArray[i].getX() + xValue > 100 || copyOfBinArray[i].getY() + yValue > 100) {

            } else {
                int binNum = copyOfBinArray[i].binNumber;

                arrayOfBins[binNum].setX(arrayOfBins[binNum].getX() + xValue);

                arrayOfBins[binNum].setY(arrayOfBins[binNum].getY() + yValue);
...
//                   
        ...
        arrayOfBins[binNum].setX(xValue);

        arrayOfBins[binNum].setY(yValue);
